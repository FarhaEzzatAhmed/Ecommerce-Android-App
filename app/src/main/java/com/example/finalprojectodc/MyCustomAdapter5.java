...
public class MyCustomAdapter5 extends RecyclerView.Adapter<MyCustomAdapter5.MyViewHolder> {

    Context ctx;
    List<Root2> products ;

    public MyCustomAdapter5(Context ctx, List<Root2> products) {
        this.ctx = ctx;
    ...
    @NonNull
    @Override
    public MyCustomAdapter5.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View recyclerView = inflater.inflate(R.layout.spesific_item_cell,parent,false);
        MyCustomAdapter5.MyViewHolder viewHolder = new MyCustomAdapter5.MyViewHolder(recyclerView);
    ...
    @Override
    public void onBindViewHolder(@NonNull MyCustomAdapter5.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ctx,ElectronicDetails.class);
